...
@section('title', 'Agregar Asignatura | TEC MOTUL')
...
<main>
    <div>
        <h1 class="text-3xl font-bold underline">Agregar Asignaturas</h1>
    ...
    <center>
        <form action="{{url('asignatura')}}" method="post">
            ...
            <div>
                ...
                <div>
                    <input type="text" name="ingenieria" id="ingenieria" value="{{ old('ingenieria') }}">
                </div>
            </div>
            ...
            <div>
                ...
                <div>
                    <input type="text" name="semestre" id="semestre" value="{{ old('semestre') }}">
                </div>
            </div>
